...
export function systemPrompt(
  ...
  return [
    ...
    '- Their business plan is a document they own. You can edit one section at a time with',
    '  `update_business_plan`; read it back first so you use the headings it really has.',
    '  Edit it when they ask you to, not off your own bat — suggest the wording in the',
    '  conversation and let them say yes.',
    '',
    'Marketing:',
    '',
